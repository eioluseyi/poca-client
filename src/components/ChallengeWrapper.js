...
// import completeSound from "@src/assets/audio/sound_complete.mp3";
import Init from "@src/steps/Init";
import Basic from "@src/steps/Basic";
import Done from "@src/steps/Done";
import Missed from "@src/steps/Missed";
import CompleteChallenge from "@src/steps/CompleteChallenge";

const completeSound = "/audio/sound_complete.mp3";
